...
function gameLaunch() {
    ...
    let reGameButton =document.createElement("button")
    let rock = document.createElement("button");
    let scissors = document.createElement("button");
    let paper = document.createElement("button");
    reGameButton.textContent = "Play again"
    text.textContent = "Make a choice";
    rock.textContent = "rock";
    scissors.textContent = "scissors";
    paper.textContent = "paper";
    reGameButton.style.marginTop = "50px";
...
//---------------------------------------------------
    function playGame(uChoice, computerChoice) {
        ...
        textArea.appendChild(reGameButton);
        reGameButton.onclick = function (){
